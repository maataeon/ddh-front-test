...
import backgroundLanding from "../../assets/landing.svg";
  ...
  return (
    <div className="Page">
      ...
      <div className="Landing-Portada">
        <Typography className="Portada-Titulo">
          Reciclaje de componentes electrónicos
        </Typography>
        <Typography className="Portada-Leyenda">
          Compramos procesadores, placas, y componentes tecnológicos en deshuso
        </Typography>
      </div>
